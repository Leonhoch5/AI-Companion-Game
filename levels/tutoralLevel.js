...
const tutorialMessages = [
    ...
    { text: "Question: Do you prefer a defensive or aggressive playstyle? Type 'defensive' or 'aggressive' and press Enter.", action: "question1" },
    { text: "Question: Do you like solving puzzles or fighting more? Type 'puzzles' or 'fighting' and press Enter.", action: "question2" },
...
function handleTutorialInput(e) {
    ...
    switch (message.action) {
        ...
        case "question1":
            if (e.key === "Enter") {
                playerAnswers.playstyle = document.querySelector("#playerInput").value.toLowerCase();
                tutorialStep++;
            }
            break;
